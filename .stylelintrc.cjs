...
module.exports = {
  extends: ['@stylistic/stylelint-config', 'stylelint-config-recess-order', 'stylelint-config-recommended', 'stylelint-config-standard-scss'],
  ...
  rules: {
    ...
    'unit-allowed-list': ['%', 's', 'ch', 'dppx', 'deg', 'rem', 'em', 'fr', 'mm', 'ms', 'px', 'vh', 'vw'],
    'value-keyword-case': [
      'lower',
      {
        ignoreProperties: ['/^--/'],
